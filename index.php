...
<body>
  ...
  <section class="competition-info">
    <div class="container">
      ...
      <a href="http://jam.pieter.com" target="_blank" class="submit-button" style="background: #e53e3e;"><span
          class="emoji-space">➡️</span>Submit Your Game Now!</a>
        ...
        <div>
          ...
          <div class="jury-members">
            ...
            foreach ($ordered_jury as $jury): ?>
              <a href="https://x.com/<?php echo htmlspecialchars(ltrim($jury['username'], '@')); ?>" target="_blank"
                class="jury-member">
                <img src="https://unavatar.io/twitter/<?php echo htmlspecialchars(ltrim($jury['username'], '@')); ?>"
        ...
        <div>
          ...
          <div class="jury-members">
            <?php while ($sponsor = $sponsors->fetchArray()): ?>
              <a href="https://x.com/<?php echo htmlspecialchars(ltrim($sponsor['username'], '@')); ?>" target="_blank"
                class="jury-member">
                <img src="https://unavatar.io/twitter/<?php echo htmlspecialchars(ltrim($sponsor['username'], '@')); ?>"
    ...
    <main class="submissions-grid">
      <?php while ($row = $result->fetchArray(SQLITE3_ASSOC)): ?>
        <article class="submission-card">
          <img class="submission-image" src="<?php echo htmlspecialchars($row['screenshot_url']); ?>"
          ...
          <div class="card-content">
            ...
            <div class="submission-meta">
              <span><span
                  class="emoji-space">🎮</span><?php echo $row['engine_used'] ? htmlspecialchars($row['engine_used']) : 'Custom Engine'; ?></span>
            ...
            <a href="<?php echo htmlspecialchars($row['game_url']); ?>" target="_blank" class="play-button"><span
                class="emoji-space">▶️</span>Play Game</a>
          </div>
        </article>
      <?php endwhile; ?>
    </main>
      ...
      <div class="sponsors-container">
        ...
        while ($sponsor = $sponsors->fetchArray()):
          ...
          <div class="sponsor-card">
            <img class="sponsor-banner" src="<?php echo $banner_url; ?>"
            ...
            <div class="sponsor-info">
              <a href="https://x.com/<?php echo $username; ?>" target="_blank" class="sponsor-link">
                <img class="sponsor-image" src="https://unavatar.io/twitter/<?php echo $username; ?>"
                  alt="Profile picture of <?php echo htmlspecialchars($sponsor['username']); ?>">
        ...
        while ($jury = $jury_members->fetchArray()):
          ...
          <div class="jury-card">
            <a href="https://x.com/<?php echo $username; ?>" target="_blank" class="jury-link">
              <img class="jury-image" src="https://unavatar.io/twitter/<?php echo $username; ?>"
                alt="Profile picture of <?php echo htmlspecialchars($jury['username']); ?>">
  ...
  <footer class="footer-section">
    <div class="container">
      <p class="footer-text">Website vibe coded by <a href="https://x.com/jogicodes" target="_blank">@jogicodes</a>
        using vanilla PHP, vanilla CSS, SQLite3 with help from Claude 3.7 and Grok 3 with some sprinkles of GPT</p>
    </div>
  </footer>
